...
export default function Enrollment() {
  function DisplayTime(val) {
    try {
      return (
        <>
          {moment(val.time[0]).format("hh:mm A")} -{" "}
          {moment(val.time[1]).format("hh:mm A")}
        </>
      );
    } catch (err) {
      ...
      render: (val) => (
        <Row>
          <Col xs={24}>
            ...
            <br />
            <span>
              <b>Days:</b> {DisplayDate(val)}
            </span>
            <br />
            <span>
              <b>Time:</b> {DisplayTime(val)}
            </span>
          </Col>
        </Row>
      ),
    },
    {
      ...
      render: (val) => (
        <Row>
          ...
          <Col xs={24} lg={17}>
            <span>
              <b>Name: </b> {val.teacher.name}
            </span>{" "}
            <br />
            <span>
              <b>Designation:</b> {val.teacher.designation}
            </span>
          </Col>
        </Row>
      ),
  ...
  const columnsE = [
    {
      ...
      render: (val) => (
        <Row>
          <Col xs={24}>
            <span>
              <b>Subject:</b> {val.class_schedule.subject}
            </span>
            <br />
            <span>
              <b>Year Level:</b> {val.class_schedule.year_level}
            </span>
            <br />
            <span>
              <b>Days:</b> {DisplayDate(val.class_schedule)}
            </span>
            <br />
            <span>
              <b>Time:</b> {DisplayTime(val.class_schedule)}
            </span>
          </Col>
        </Row>
      ),
  ...
  async function Add(file, values) {
    try {
      await EnrollStudent(values).then((res) => {
      ...
      return (
        <>
          {students !== null &&
            students.map((val, k) => {
              return (
                <Select.Option value={JSON.stringify(val)} key={k}>
                  <Col xs={24}>
                    <img
                      src={val.image}
                      width={20}
  ...
  return (
    <>
      <Row gutter={[24, 5]}>
        ...
        {selStud.length > 0 && <Col xs={24}>{StudentUI(selStud, image)}</Col>}
