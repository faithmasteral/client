...
export default function SummaryReport(props) {
              ...
              <DatePicker
                ...
                onChange={async (e) => {
                  ...
                  if (e === null) {
                    ...
                    await setAttendanceSummary(
                      e,
                      { class_schedule: JSON.parse(selSched)._id },
                      "",
                      "teacher class_schedule student"
                    );
                  }
                }}
              />
  ...
  const columns = [
    {
      title: "Stud ID",
      render: (val) => <span>{val.student_id}</span>,
    },
    {
      title: <center>Student</center>,
      render: (val) => <center>{val.student}</center>,
    },
    {
      title: "Date",
      render: (val) => (
    ...
    },
    {
      ...
      render: (val) => <center>{val.remarks}</center>,
    },
  ];
  return (
    <Row gutter={[24, 5]}>
      <Col xs={24}>
        ...
        >
          ...
          {selSched.length > 0 && <Col xs={24}>{ScheduleUI(selSched)}</Col>}
          <b>Summary Report</b>
          <br />
